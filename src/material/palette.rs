...
pub struct Palette {
    ...
    pub light_background_text_disabled: Color,
    ...
    pub dark_background_text_disabled: Color,
...
impl Default for Palette {
    fn default() -> Self {
        Palette {
            ...
            light_background_text_disabled: super::Color::LightBackgroundTextDisabled.into(),
            ...
            dark_background_text_disabled: super::Color::DarkBackgroundTextDisabled.into(),
